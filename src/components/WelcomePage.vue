<template>
  <div class="column">
    <img src="/static/images/pixy.png"/>
    <h1>Pixy, the picture vault</h1>
    <h2>A digital feed of your own pictures! Upload and have private access to all your pictures.</h2>
